    ...
    <div className="text-center">
      <form onSubmit={handleSubmit} className="form-signin">
        ...
        <div className="form-group">
          ...
          {errors.request && <small className="form-text text-white">Please check username</small>}
        </div>
        <div className="form-group">
          <input onInput={handleChange} name="password" type="password" className="form-control" placeholder="Enter password" />
          {errors.request && <small className="form-text text-white">Please check password contains atleast 8 characters</small>}
        </div>
        <div className="form-group">
